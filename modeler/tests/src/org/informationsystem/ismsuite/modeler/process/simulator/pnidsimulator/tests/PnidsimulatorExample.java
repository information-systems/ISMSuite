...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>pnidsimulator</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class PnidsimulatorExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(PnidsimulatorPackage.eNS_URI, 
			 PnidsimulatorPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.pnidsimulator"));
				TransitionActivationAnnotation root = PnidsimulatorFactory.eINSTANCE.createTransitionActivationAnnotation();
