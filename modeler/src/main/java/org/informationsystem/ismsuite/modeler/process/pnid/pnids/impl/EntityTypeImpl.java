 ...
 * </p>
 * <ul>
 *   <li>{@link org.informationsystem.ismsuite.modeler.process.pnid.pnids.impl.EntityTypeImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityTypeImpl extends LabelImpl implements EntityType {
	/**
	...
	protected EClass eStaticClass() {
		return PnidsPackage.Literals.ENTITY_TYPE;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnidsPackage.ENTITY_TYPE__TEXT, oldText, text));
	}
