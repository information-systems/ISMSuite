 ...
 * @generated
 */
public class PnidsimulatorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PnidsimulatorPackage.TRANSITION_ACTIVATION_ANNOTATION: {
			...
			case PnidsimulatorPackage.PLACE_MARKING_ANNOTATION: {
