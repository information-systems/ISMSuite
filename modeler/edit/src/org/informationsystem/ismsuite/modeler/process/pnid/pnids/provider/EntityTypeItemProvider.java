...
/**
 * This is the item provider adapter for a {@link org.informationsystem.ismsuite.modeler.process.pnid.pnids.EntityType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityTypeItemProvider extends LabelItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntityType_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntityType_text_feature", "_UI_EntityType_type"),
				 PnidsPackage.Literals.ENTITY_TYPE__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((EntityType)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EntityType.class)) {
			case PnidsPackage.ENTITY_TYPE__TEXT:
