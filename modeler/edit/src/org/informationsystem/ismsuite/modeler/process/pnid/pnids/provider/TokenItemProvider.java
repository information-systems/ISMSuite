...
/**
 * This is the item provider adapter for a {@link org.informationsystem.ismsuite.modeler.process.pnid.pnids.Token} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PnidsPackage.Literals.TOKEN__ENTITY);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Token.class)) {
			case PnidsPackage.TOKEN__ENTITY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PnidsPackage.Literals.TOKEN__ENTITY,
				 PnidsFactory.eINSTANCE.createEntity()));
	}
