...
/**
 * This is the item provider adapter for a {@link org.informationsystem.ismsuite.modeler.process.pnid.pnids.Place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlaceItemProvider extends org.pnml.tools.epnk.pnmlcoremodel.provider.PlaceItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PnidsPackage.Literals.PLACE__TYPE);
			childrenFeatures.add(PnidsPackage.Literals.PLACE__INITIAL_MARKING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PnidsPackage.Literals.PLACE__TYPE,
				 PnidsFactory.eINSTANCE.createEntityTypeLabel()));

		newChildDescriptors.add
			(createChildParameter
				(PnidsPackage.Literals.PLACE__INITIAL_MARKING,
				 PnidsFactory.eINSTANCE.createPNIDMarking()));
	}
