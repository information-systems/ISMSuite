...
/**
 * This is the item provider adapter for a {@link org.informationsystem.ismsuite.modeler.process.pnid.pnids.Transaction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransactionItemProvider extends LabelItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transaction_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transaction_text_feature", "_UI_Transaction_type"),
				 PnidsPackage.Literals.TRANSACTION__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Transaction)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Transaction.class)) {
			case PnidsPackage.TRANSACTION__TEXT:
