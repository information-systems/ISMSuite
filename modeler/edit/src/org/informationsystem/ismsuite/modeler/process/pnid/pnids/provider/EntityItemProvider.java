...
/**
 * This is the item provider adapter for a {@link org.informationsystem.ismsuite.modeler.process.pnid.pnids.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends LabelItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_text_feature", "_UI_Entity_type"),
				 PnidsPackage.Literals.ENTITY__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Entity)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Entity.class)) {
			case PnidsPackage.ENTITY__TEXT:
