...
/**
 * This is the item provider adapter for a {@link org.informationsystem.ismsuite.modeler.process.pnid.pnids.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider extends LabelItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_text_feature", "_UI_Variable_type"),
				 PnidsPackage.Literals.VARIABLE__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Variable)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Variable.class)) {
			case PnidsPackage.VARIABLE__TEXT:
